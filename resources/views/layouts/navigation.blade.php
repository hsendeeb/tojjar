<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 fixed-top">
                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('profile.index', Auth::id())">
                                {{ __('Profile') }}
                                @if(Auth::user()->image != 'public/images/avatar.jpg')
