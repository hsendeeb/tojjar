  ...
  @endif
    ...
    <div class="container-fluid gap-3 d-flex mt-5 p-5">
        ...
        <table class="table table-striped p-2">
             <tr ><th class=" text-center bg-warning archivo rounded-pill px-2 py-1">Records:{{count($admins)}}</th></tr>
            <tr>
                <th>Id</th>
                <th>name</th>
                <th>last name</th>
            ...
            <tr>
                ...
                <td><img class="rounded-circle" style="width:30px;height:30px" src='{{ Storage::url($admin->user->image) }}'></td>
                <td>
